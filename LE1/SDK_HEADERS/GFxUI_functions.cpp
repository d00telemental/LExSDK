...
void UGFxMovie::Update ( float fDeltaT )
{
	...
	if ( ! pFnUpdate )
		pFnUpdate = UObject::FindObject< UFunction > ( "Function GFxUI.GFxMovie.Update" );
...
bool UGFxMovie::IsUsingGamepad ( )
{
	...
	if ( ! pFnIsUsingGamepad )
		pFnIsUsingGamepad = UObject::FindObject< UFunction > ( "Function GFxUI.GFxMovie.IsUsingGamepad" );
