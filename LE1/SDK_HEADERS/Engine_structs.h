...
struct FEntityVariable
{
	...
	struct FString                                     VariableName;                                     		// 0x0004 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct FString                                     VariableState;                                    		// 0x0014 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct TArray<struct FString>                      ValidVariableStates;                              		// 0x0024 (0x0010) [0x0000000000420001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
};
...
struct FSoundEntityVariable
{
	...
	struct FString                                     VariableState;                                    		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FString>                      ValidVariableStates;                              		// 0x0020 (0x0010) [0x0000000000420000]              ( CPF_EditConst | CPF_NeedCtorLink )
...
struct FSoundGroup
{
	...
	struct FName                                       GroupName;                                        		// 0x0030 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct TArray<struct FName>                        ChildGroupNames;                                  		// 0x0038 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
struct FFireLink
{
	struct TArray<struct FFireLinkItem>                Items;                                            		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FCoverSlot
{
	...
	struct TArray<struct FFireLink>                    FireLinks;                                        		// 0x0010 (0x0010) [0x0000000000600000]              ( CPF_NeedCtorLink )
	struct TArray<struct FFireLink>                    ForcedFireLinks;                                  		// 0x0020 (0x0010) [0x0000000000600000]              ( CPF_NeedCtorLink )
	struct TArray<struct FFireLink>                    RejectedFireLinks;                                		// 0x0030 (0x0010) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	struct TArray<struct FExposedLink>                 ExposedFireLinks;                                 		// 0x0040 (0x0010) [0x0000000000600001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct TArray<struct FDangerLink>                  DangerLinks;                                      		// 0x0050 (0x0010) [0x0000000000600001]              ( CPF_Edit | CPF_NeedCtorLink )
	struct TArray<struct FCoverReference>              TurnTarget;                                       		// 0x0060 (0x0010) [0x0000000000600000]              ( CPF_NeedCtorLink )
	struct TArray<struct FSlotMoveRef>                 SlipRefs;                                         		// 0x0070 (0x0010) [0x0000000000600000]              ( CPF_NeedCtorLink )
	struct TArray<struct FCoverReference>              OverlapClaims;                                    		// 0x0080 (0x0010) [0x0000000000620001]              ( CPF_Edit | CPF_EditConst | CPF_NeedCtorLink )
...
{
	struct TArray<struct FBioGesturePinScrubData>      aGestPins;                                        		// 0x0060 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FName                                       nmNextPoseSet;                                    		// 0x0070 (0x0008) [0x0000000000000000]              
	struct FName                                       nmNextPoseAnim;                                   		// 0x0078 (0x0008) [0x0000000000000000]              
...
{
	struct FString                                     HandlerClass;                                     		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     PanelResource;                                    		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     PanelClass;                                       		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	struct FString                                     SharedFile;                                       		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     SharedResource;                                   		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
};
...
{
	struct FPointer                                    Dummy1;                                           		// 0x0000 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	struct FPointer                                    Dummy2;                                           		// 0x0008 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	struct FString                                     Dummy3;                                           		// 0x0010 (0x0010) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	...
	struct FPointer                                    Dummy6;                                           		// 0x0028 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	...
	struct FPointer                                    Dummy10;                                          		// 0x0038 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
};
...
struct FSFPanelCachedInvoke
{
	...
	struct TArray<unsigned char>                       lstQualifications;                                		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	struct TArray<struct UEngineTypes_FSubtitleCue>    Subtitles;                                        		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	struct FString                                     Suffix;                                           		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
	struct TArray<struct FName>                        PackagesToExclude;                                		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
