...
{
public:
	struct FPointer                                    Socket;                                           		// 0x0284 (0x0008) [0x0000000000000002]              ( CPF_Const )
...
{
public:
	struct TArray<unsigned char>                       SendFIFO;                                         		// 0x02A8 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     RecvBuf;                                          		// 0x02B8 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
public:
	...
	struct FString                                     ServerName;                                       		// 0x0428 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ServerURL;                                        		// 0x0438 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	struct FString                                     ReceivedData;                                     		// 0x02E8 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
