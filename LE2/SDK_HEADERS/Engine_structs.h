...
struct FUIStringNode
{
	...
	struct FPointer                                    ParentNode;                                       		// 0x0010 (0x0008) [0x0000000000103002]              ( CPF_Const | CPF_Native | CPF_Transient )
	struct FString                                     SourceText;                                       		// 0x0018 (0x0010) [0x0000000000500001]              ( CPF_Edit | CPF_NeedCtorLink )
