...
class UClass* UBioSeqAct_IsPerformance::pClassPointer = NULL;

class UClass* UBioSeqAct_IsPerformance::StaticClass()
	{
		if ( ! pClassPointer )
			pClassPointer = UObject::FindClass ( "Class SFXQA.BioSeqAct_IsPerformance" );

		return pClassPointer;
	};

// Function SFXQA.BioSeqAct_IsPerformance.Activated
// [0x00020002] 
// Parameters infos:

void UBioSeqAct_IsPerformance::Activated ( )
{
	static UFunction* pFnActivated = NULL;

	if ( ! pFnActivated )
		pFnActivated = UObject::FindObject< UFunction > ( "Function SFXQA.BioSeqAct_IsPerformance.Activated" );

	UBioSeqAct_IsPerformance_execActivated_Parms Activated_Parms;
