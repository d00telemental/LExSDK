...
{
public:
	struct FPointer                                    VfTable_IWwiseComponentCallback;                  		// 0x010C (0x0008) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	class UWwiseBaseSoundObject*                       WwiseObject;                                      		// 0x0114 (0x0008) [0x0000000000000001]              ( CPF_Edit )
	struct FPointer                                    CriticalSection;                                  		// 0x011C (0x0008) [0x0000000000023002]              ( CPF_Const | CPF_Native | CPF_Transient | CPF_EditConst )
	struct TArray<class UWwiseAudioComponent*>         ActiveComponents;                                 		// 0x0124 (0x0010) [0x00000000044A000B]              ( CPF_Edit | CPF_Const | CPF_ExportObject | CPF_EditConst | CPF_Component | CPF_NeedCtorLink | CPF_EditInline )
...
public:
	...
	struct FName                                       m_ComponentGroup;                                 		// 0x0138 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	struct TArray<struct FWwisePlatformRelationships>  References;                                       		// 0x0060 (0x0010) [0x0000000000420003]              ( CPF_Edit | CPF_Const | CPF_EditConst | CPF_NeedCtorLink )
...
{
public:
	struct TArray<struct FWwiseDialogueArgument>       Arguments;                                        		// 0x0090 (0x0010) [0x0000000000420003]              ( CPF_Edit | CPF_Const | CPF_EditConst | CPF_NeedCtorLink )
...
{
public:
	struct TArray<struct FWwisePlatformData>           PlatformData;                                     		// 0x0060 (0x0010) [0x0000000000021002]              ( CPF_Const | CPF_Native | CPF_EditConst )
...
{
public:
	struct TArray<struct FPointer>                     Children;                                         		// 0x0078 (0x0010) [0x0000000000023002]              ( CPF_Const | CPF_Native | CPF_Transient | CPF_EditConst )
...
{
public:
	struct FName                                       Filename;                                         		// 0x0078 (0x0008) [0x0000000000000002]              ( CPF_Const )
	struct FName                                       BankName;                                         		// 0x0080 (0x0008) [0x0000000000020003]              ( CPF_Edit | CPF_Const | CPF_EditConst )
...
{
public:
	struct TArray<struct FWwiseEventPair>              WwiseEventArray;                                  		// 0x02D4 (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
...
{
public:
	struct FName                                       MusicID;                                          		// 0x02D4 (0x0008) [0x0000000000000001]              ( CPF_Edit )
...
{
public:
	struct FString                                     RTPCName;                                         		// 0x028C (0x0010) [0x0000000000400001]              ( CPF_Edit | CPF_NeedCtorLink )
