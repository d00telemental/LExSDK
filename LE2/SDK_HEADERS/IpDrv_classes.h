...
{
public:
	struct FPointer                                    Socket;                                           		// 0x028C (0x0008) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    RemoteSocket;                                     		// 0x0294 (0x0008) [0x0000000000000002]              ( CPF_Const )
	struct FPointer                                    PrivateResolveInfo;                               		// 0x029C (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
...
{
public:
	struct TArray<unsigned char>                       SendFIFO;                                         		// 0x02B0 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
	struct FString                                     RecvBuf;                                          		// 0x02C0 (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
{
public:
	struct FPointer                                    VoiceEngine;                                      		// 0x015C (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
...
public:
	...
	struct FPointer                                    LanBeacon;                                        		// 0x01A0 (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	struct FPointer                                    SessionInfo;                                      		// 0x01A8 (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
...
{
public:
	struct FString                                     Applications[ 0xA ];                              		// 0x02F0 (0x00A0) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ApplicationPaths[ 0xA ];                          		// 0x0390 (0x00A0) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ServerName;                                       		// 0x0430 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
...
{
public:
	struct FString                                     ReceivedData;                                     		// 0x02F0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
