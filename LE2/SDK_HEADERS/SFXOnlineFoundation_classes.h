...
public:
	struct FPointer                                    VfTable_IISFXOnlineComponent;                     		// 0x0094 (0x0008) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	struct TArray<struct FSFXCachedAchievements>       CachedAchievementList;                            		// 0x009C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	struct TArray<struct FScriptDelegate>              LocalPlayerStorageReadDelegates;                  		// 0x028C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              LocalPlayerStorageWriteDelegates;                 		// 0x029C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              RemotePlayerStorageReadDelegates;                 		// 0x02AC (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              LoginCancelledDelegates;                          		// 0x02BC (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              LoginFailedDelegates;                             		// 0x02CC (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              LogoutCompletedDelegates;                         		// 0x02DC (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              LoginChangeDelegates;                             		// 0x02EC (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FLoginStatusDelegates                       PlayerLoginStatusDelegates[ 0x4 ];                		// 0x02FC (0x0040) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     ProfileDataDirectory;                             		// 0x033C (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     ProfileDataExtension;                             		// 0x034C (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     LoggedInPlayerName;                               		// 0x035C (0x0010) [0x0000000000400002]              ( CPF_Const | CPF_NeedCtorLink )
...
public:
	...
	struct TArray<struct FScriptDelegate>              ExternalUIChangeDelegates;                        		// 0x00A0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              ControllerChangeDelegates;                        		// 0x00B0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FTitleFile>                   TitleManagedFiles;                                		// 0x00C0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              ReadTitleFileCompleteDelegates;                   		// 0x00D0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              StorageDeviceChangeDelegates;                     		// 0x00E0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              ConnectionStatusChangeDelegates;                  		// 0x00F0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct TArray<struct FScriptDelegate>              LinkStatusChangeDelegates;                        		// 0x0100 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
public:
	struct FPointer                                    VfTable_IISFXOnlineComponentPlatform;             		// 0x0094 (0x0008) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	struct FPointer                                    NotificationHandle;                               		// 0x009C (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
	...
	struct TArray<struct FPointer>                     OverlappedTasks;                                  		// 0x0108 (0x0010) [0x0000000000001000]              ( CPF_Native )
...
public:
	...
	struct FPointer                                    NpData;                                           		// 0x00AC (0x0008) [0x0000000000003002]              ( CPF_Const | CPF_Native | CPF_Transient )
...
public:
	...
	struct FPointer                                    CurrentBlazeHub;                                  		// 0x00C0 (0x0008) [0x0000000000001000]              ( CPF_Native )
	struct FPointer                                    BlazeNetworkAdapter;                              		// 0x00C8 (0x0008) [0x0000000000001000]              ( CPF_Native )
...
public:
	...
	struct FPointer                                    ConnectionMgr;                                    		// 0x00AC (0x0008) [0x0000000000001000]              ( CPF_Native )
	struct FPointer                                    LoginMgr;                                         		// 0x00B4 (0x0008) [0x0000000000001000]              ( CPF_Native )
	struct FPointer                                    m_pAuthComponent;                                 		// 0x00BC (0x0008) [0x0000000000001000]              ( CPF_Native )
	struct TArray<struct FString>                      m_asEntitlements;                                 		// 0x00C4 (0x0010) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	struct TArray<struct FString>                      m_asGrantedEntitlements;                          		// 0x00D4 (0x0010) [0x0000000000402000]              ( CPF_Transient | CPF_NeedCtorLink )
	...
	struct FString                                     PendingConnectEmail;                              		// 0x00F0 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     PendingConnectPassword;                           		// 0x0100 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	...
	struct FString                                     PendingConnectCountryCode;                        		// 0x011C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     PendingConnectLanguageCode;                       		// 0x012C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     PendingConnectParentalEmail;                      		// 0x013C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     PendingBuyStoreURL;                               		// 0x014C (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	int                                                PendingConnectError;                              		// 0x015C (0x0004) [0x0000000000000000]              
	int                                                PendingConnectBlazeError;                         		// 0x0160 (0x0004) [0x0000000000000000]              
	struct TArray<struct FSFXOfferDescriptor>          PendingBuyOffers;                                 		// 0x0164 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
{
public:
	struct FPointer                                    VfTable_IISFXOnlineComponentNotification;         		// 0x0094 (0x0008) [0x0000000000801002]              ( CPF_Const | CPF_Native | CPF_NoExport )
	struct FPointer                                    m_pBlazeUtil;                                     		// 0x009C (0x0008) [0x0000000000001000]              ( CPF_Native )
	struct TArray<struct FSFXOnlineDLCInfo>            m_aDLCInfo;                                       		// 0x00A4 (0x0010) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	struct TArray<struct FSFXOnlineEntitlementGroupInfo> m_aEntitlementGroups;                             		// 0x00B4 (0x0010) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
	struct TArray<struct FSFXOnlineMOTDInfo>           m_aMOTDInfo;                                      		// 0x00C4 (0x0010) [0x0000000000003000]              ( CPF_Native | CPF_Transient )
...
public:
	...
	struct FString                                     InitTestServerAddressOverride;                    		// 0x00A0 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     InitProdServerAddressOverride;                    		// 0x00B0 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	int                                                InitServerPortOverride;                           		// 0x00C0 (0x0004) [0x0000000000004000]              ( CPF_Config )
	struct FString                                     InitDomain;                                       		// 0x00C4 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	int                                                InitTitleProjectId;                               		// 0x00D4 (0x0004) [0x0000000000004000]              ( CPF_Config )
	struct FString                                     InitTitleMode;                                    		// 0x00D8 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
	struct FString                                     InitDisabledCountryList;                          		// 0x00E8 (0x0010) [0x0000000000404000]              ( CPF_Config | CPF_NeedCtorLink )
